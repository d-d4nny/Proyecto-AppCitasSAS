...
public class LogAspecto {
	...
	@AfterThrowing(pointcut = "execution(* appCitas.AppCitasSASv2..*.*(..))", throwing = "ex")
    ...
    @Before("execution(* appCitas.AppCitasSASv2..*.*(..))")
    ...
    @AfterReturning("execution(* appCitas.AppCitasSASv2..*.*(..))")
