...
public class SeguridadEmpleadoConfig {
        ...
        http
            ...
            .formLogin(login ->
                login
                    ...
                    .defaultSuccessUrl("/privada/homeEmpleado", true) // Establece la URL de redirección después de un inicio de sesión exitoso.
